...
CREATE TABLE `message` (
  ...
  CONSTRAINT `FKiimr93ytmcuira5le0sldvvma` FOREIGN KEY (`channel_id`) REFERENCES `channel` (`id`),
...
INSERT INTO `user` VALUES (1,'miriam'),(2,'lewis');
...
CREATE TABLE `user_channel` (
  ...
  PRIMARY KEY (`user_id`,`users_id`),
  KEY `FKkswvq0454d50yd5c0fk17c4be` (`users_id`),
  CONSTRAINT `FK5oautn7r8n5bejaj8y1p9b4ue` FOREIGN KEY (`user_id`) REFERENCES `channel` (`id`),
  CONSTRAINT `FK7k86yluxw6wwjw5kfmgtyrvul` FOREIGN KEY (`users_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FKkswvq0454d50yd5c0fk17c4be` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Eloise'),(2,'Annie'),(3,'Mims'),(4,'madonna');
...
-- Dump completed on 2024-04-06 15:45:46
